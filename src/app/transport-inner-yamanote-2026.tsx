...
export const App = () => (
	<BaseLayout scope="transport-inner-yamanote-2026" isCentering={true}>
		<h1>山手線内運賃表(2026春～)</h1>
		<p>2026/03改定予定 (2025/02/01時点の情報) IC運賃</p>
		<div><Canvas /></div>

		<h2>ご注意</h2>
		<ul>
			<li>現時点では<em><strong>予定情報</strong></em>であり確定情報ではありません</li>
